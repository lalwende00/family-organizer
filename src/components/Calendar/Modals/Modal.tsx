function Modal() {
    ...
    return (
        <>
        <div className="fixed hidden inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full" id="my-modal"></div>
          ...
          {/* <div id="extralarge-modal" tabIndex={-1} className="fixed top-0 left-0 right-0 z-50 w-full hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
